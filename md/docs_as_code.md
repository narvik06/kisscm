...
![Результат компиляции LaTeX-документа](../images/docs1.svg){#fig:docs1}
...
![Полученные формулы](../images/docs2.svg){#fig:docs2}
...
![Схема работы системы WEB](../images/docs3.svg){#fig:docs3}

На @fig:docs4 показан пример LaTeX-документа, извлеченного из WEB-файла.

![Пример WEB-документа](../images/docs4.svg){#fig:docs4}
...
![Архитектура Pandoc](../images/docs5.svg){#fig:docs5}
...
![Результат работы Graphviz](../images/docs6.svg){#fig:docs6}
...
![Результат работы PlantUML](../images/docs7.svg){#fig:docs7}
