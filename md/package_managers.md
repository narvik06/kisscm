...
![Формат версии по спецификации SemVer](../images/pm3.svg){#fig:pm3}
...
![Зависимости пакета instead](../images/pm1.svg){#fig:pm1}
...
![Пример задачи разрешения зависимостей пакетов](../images/pm2.svg){#fig:pm2}
